...
def gerar_relatorio_comparativo(resultados: list, caminho_saida: str) -> str:
    ...
    linhas.extend(["", "## Violacoes de Limiar", ""])
    for resultado in resultados:
    ...
    linhas.extend([
        f"- **Maior cobertura de ferramentas:** {melhor_cobertura}",
        f"- **Menor custo em tokens:** {melhor_tokens}",
        f"- **Mais rapido:** {melhor_tempo}",
        f"- **Menos etapas:** {melhor_etapas}",
        "",
...
def gerar_relatorio_framework(resultados: list, caminho_saida: str) -> str:
    ...
    linhas = [
        ...
        "",
        "Comparacao entre o baseline **padrao** e a media das arquiteturas cognitivas.",
        "",
