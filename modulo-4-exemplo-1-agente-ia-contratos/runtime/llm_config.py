...
def _criar_cliente_openai(api_key: str, base_url: str | None = None, headers: dict | None = None):
    ...
    try:
        ...
        kwargs["http_client"] = httpx.Client(verify=certifi.where(), timeout=60.0)
    except ImportError:
        pass
        ...
        return (
            _criar_cliente_openai(
                ...
                headers={
                    ...
                    "X-Title": os.environ.get("OPENROUTER_X_TITLE", "POS UNIPDS - Agente Contratos"),
                },
            ),
            os.environ.get("OPENROUTER_MODEL", "google/gemma-2-9b-it:free"),
        )
