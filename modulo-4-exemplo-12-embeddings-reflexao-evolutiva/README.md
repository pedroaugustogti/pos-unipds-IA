# Atividade: Embeddings Reflexao Evolutiva

Este diretório é o **Módulo 4 — Exemplo 12** (`modulo-4-exemplo-12-embeddings-reflexao-evolutiva`) — adaptação local da atividade da pós-graduação **Engenharia de IA Aplicada (UNIPDS)**.
...
Implementar atividade baseada em aula14-embeddings-reflexao-evolutiva do repositorio UNIPDS
