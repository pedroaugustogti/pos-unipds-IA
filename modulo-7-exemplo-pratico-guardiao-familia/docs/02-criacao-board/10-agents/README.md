...
```powershell
cd modulo-7-exemplo-pratico-guardiao-familia/docs/02-criacao-board/10-agents/crew
...
```powershell
cd modulo-7-exemplo-pratico-guardiao-familia/docs/02-criacao-board/10-agents/scripts
