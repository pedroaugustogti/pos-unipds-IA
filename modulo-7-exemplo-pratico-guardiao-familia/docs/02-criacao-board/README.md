...
| 8. Board JSON | [08-board/github-project-2-import.json](08-board/github-project-2-import.json) | Import GitHub + [dashboard HTML](https://pedroaugustogti.github.io/pos-unipds-IA/modulo-7-exemplo-pratico-guardiao-familia/docs/02-criacao-board/08-board/backlog-dashboard.html) |
...
```powershell
python docs/02-criacao-board/scripts/generate_board_v2.py
```
...
python docs/02-criacao-board/scripts/import_github_project_v2.py --dry-run
python docs/02-criacao-board/scripts/import_github_project_v2.py
```
