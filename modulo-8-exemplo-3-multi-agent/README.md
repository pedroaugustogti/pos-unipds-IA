# Atividade: Multi-Agent

Este diretório é o **Módulo 8 — Exemplo 3** (`modulo-8-exemplo-3-multi-agent`) — adaptação local da atividade da pós-graduação **Engenharia de IA Aplicada (UNIPDS)**.

Referência UNIPDS: [modulo-03-multi-agent](https://github.com/unipds-engenharia-de-ia-aplicada/engenharia-de-software-com-ia-aplicada/tree/main/modulo08-arquitetura-de-sistemas-com-ia/modulo-03-multi-agent)

## Objetivo

Implementar Multi-Agent conforme material UNIPDS TrialForge
...
```bash
cd modulo-8-exemplo-3-multi-agent
...
- [ ] Pasta criada no padrão `modulo-8-exemplo-3-*`
