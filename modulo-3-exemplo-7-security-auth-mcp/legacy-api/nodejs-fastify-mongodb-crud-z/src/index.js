...
import { initAuthRoute, JWT_SECRET, rateLimitOptions, requireAccess } from './auth.js';
...
fastify.post('/v1/customers', {
    preHandler: [requireAccess([{ roles: ['admin'], departments: ['sales'] }])],
    schema: {
        body: {
            type: 'object',
            required: ['name', 'phone'],
...
fastify.put('/v1/customers/:id', {
    preHandler: [requireAccess([
        { roles: ['admin'], departments: ['sales'] },
        { roles: ['member'], departments: ['support'] },
    ])],
    schema: {
        body: {
            type: 'object',
