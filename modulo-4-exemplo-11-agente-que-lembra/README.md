# Atividade: Agente Que Lembra

Este diretório é o **Módulo 4 — Exemplo 11** (`modulo-4-exemplo-11-agente-que-lembra`) — adaptação local da atividade da pós-graduação **Engenharia de IA Aplicada (UNIPDS)**.

Referência UNIPDS: [aula13-agente-que-lembra](https://github.com/unipds-engenharia-de-ia-aplicada/engenharia-de-software-com-ia-aplicada/tree/main/modulo04-agentes-autonomos/aula13-agente-que-lembra)

## Objetivo

Implementar atividade baseada em aula13-agente-que-lembra do repositorio UNIPDS
...
```bash
cd modulo-4-exemplo-11-agente-que-lembra
