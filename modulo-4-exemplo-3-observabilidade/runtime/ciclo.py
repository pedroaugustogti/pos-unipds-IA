...
def rodar(caminho_agente: str, texto_entrada: str, modo: str = None, evento: str = None, saida: str = None) -> dict:
    ...
    while not estado["concluido"] and estado["etapa"] < estado["max_etapas"]:
        ...
        plano, uso_tokens_plano = chamar_llm(percepcao, contratos, estado["historico"], estado["entrada"])
            ...
            # fallback: ferramenta nao existe, redirecionar para proxima nao usada
                ...
                if ferramenta_fallback:
                    ...
                    plano = {
                        ...
                        "argumentos_ferramenta": montar_argumentos_mock(habilidade_fb, estado["historico"], estado["entrada"]),
        ...
        if plano.get("proxima_acao") == "FINALIZAR":
            ...
            if faltantes:
                ...
                plano = {
                    ...
                    "argumentos_ferramenta": montar_argumentos_mock(habilidade_faltante, estado["historico"], estado["entrada"]),
