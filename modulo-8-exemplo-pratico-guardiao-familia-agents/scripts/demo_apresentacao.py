...
from lib.claim_lock import load_locks, release_lock, save_locks  # noqa: E402
from lib.env_load import ensure_env  # noqa: E402
from lib.event_orchestrator import load_runtime, save_runtime, set_agent_state  # noqa: E402
...
DEMO_WS = ROOT / "crew" / "output" / "demo_workspace"
REPORT_PATH = ROOT / "crew" / "output" / "demo_apresentacao_report.json"
...
DEMO_ACTIONS: dict[str, dict[str, Any]] = {
    ...
    "__implement__": {
        ...
        "observation": (
            "Artefatos gravados em crew/output/demo_workspace/T-P05-005/; commit local criado; "
