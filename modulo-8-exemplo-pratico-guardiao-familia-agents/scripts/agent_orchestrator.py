...
PR_TEMPLATE = ROOT / "docs" / "templates" / "PR_TEMPLATE.md"
SKILLS = ROOT / "skills"
...
6. Comentar issue e mover card para Ready for Code Review
   (`task_status_cli.py --event open_pr` → JSON local + gh Project #2)
