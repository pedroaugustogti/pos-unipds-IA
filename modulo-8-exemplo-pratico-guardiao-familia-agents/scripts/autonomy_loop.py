...
from lib.claim_lock import DEFAULT_WIP_PER_ROLE, check_claim_allowed, count_in_progress_for_role  # noqa: E402
from lib.dispatch_adapter import drain_queued  # noqa: E402
from lib.env_load import ensure_env  # noqa: E402
from lib.gateway import emit_status_event, list_hitl_queue  # noqa: E402

ensure_env()
from lib.hitl_gates import is_high_risk_task  # noqa: E402
...
from lib.pilot import PILOT_ROLES, PILOT_SPRINT, PILOT_TASK_IDS  # noqa: E402
...
def _retry_outbox(*, dry_run: bool) -> dict[str, Any]:
    ...
    from lib.board_client import _update_github_status, add_labels
...
def run_cycle(
    *,
    ...
    if dry_run:
        ...
        from lib.worker_jobs import load_jobs
    ...
    from lib.event_orchestrator import list_idle_agents
    ...
    from lib.event_orchestrator import load_runtime, save_runtime
    ...
    if os.environ.get("GUARDAO_PUBLISH_LIVE", "").strip() in ("1", "true", "True"):
        _spec = importlib.util.spec_from_file_location(
            "guardiao_publish_live", ROOT / "scripts" / "publish_live_pages.py"
        )
