...
JOBS_PATH = MODULE_ROOT / "crew" / "output" / "worker_jobs.json"
...
def enqueue_job(
    *,
    ...
    job = {
        ...
        "role": role,
        "event": event,
        "handoff_path": str(MODULE_ROOT / "crew" / "output" / "handoffs" / f"{task_id}.json"),
        "agent_prompt": agent_prompt or f"agents/{role}.agent.md",
        "status": "queued",
        "created_at": _iso(),
        "lease_until": None,
    }
