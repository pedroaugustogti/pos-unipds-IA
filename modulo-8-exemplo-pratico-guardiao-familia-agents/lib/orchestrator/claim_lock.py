...
from board_automation.board.local_board import get_local_status, load_board, save_board
from lib.paths import MODULE_ROOT
from board_automation.board.task_status_workflow import resolve_status

from lib.paths import CLAIM_LOCKS_PATH

LOCKS_PATH = CLAIM_LOCKS_PATH
