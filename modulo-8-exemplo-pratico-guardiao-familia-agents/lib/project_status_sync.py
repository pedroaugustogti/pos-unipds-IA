...
from lib.board_client import ORG, PROJECT_NUMBER, _get_status_field, _graphql
from lib.status_labels import STATUS_LABELS
from lib.task_status_workflow import AGENT_STAGES, STATUSES
...
def ensure_status_labels(*, dry_run: bool = False) -> dict[str, Any]:
    ...
    from lib.board_client import _gh_run
