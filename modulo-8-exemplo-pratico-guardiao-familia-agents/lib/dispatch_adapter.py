...
from lib.repo_paths import github_repo_url, resolve_repo_path
...
def _load_worker_mod():
    path = MODULE_ROOT / "scripts" / "worker_run.py"
...
def dispatch_job(
    ...
    *,
    ...
    if result_path.exists():
        from lib.complete_dispatch import apply_dispatch_result
        ...
        **base,
        ...
        "hint": (
            ...
            if completion and completion.get("ok")
                ...
                f"python scripts/complete_dispatch.py --job {job_id}"
            )
        ),
    }
