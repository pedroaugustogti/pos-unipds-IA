...
from lib.event_contract import EventPayload
from lib.event_orchestrator import (
...
from lib.handoff import write_handoff
from lib.hitl_gates import evaluate_hitl
...
def emit_status_event(
    ...
    *,
    ...
    if event == "claim" and not force_hitl_approved:
        from lib.claim_lock import check_claim_allowed
    ...
    from lib.event_schema import validate_event_payload
