...
def build_snapshot() -> dict[str, Any]:
    ...
    from lib.outbox import read_pending
    from lib.pilot import PILOT_TASK_IDS
    from lib.task_action_history import list_task_history_links
    from lib.task_router import load_tasks
    from lib.task_status_workflow import STATUSES
