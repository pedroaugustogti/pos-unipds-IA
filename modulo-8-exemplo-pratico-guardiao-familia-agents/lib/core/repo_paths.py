...
REPO_ENV = {
    ...
    "guardiao-familia-mobile-setup": "GUARDAO_MOBILE_SETUP_PATH",
}
...
DEFAULT_PATHS = {
    ...
    "guardiao-familia-mobile-setup": Path(
        r"C:\Users\pedro\Documents\guardiao-familia\guardiao-familia-mobile-setup"
    ),
}
