...
**Classificação:** reviewer · **Papel:** `devops-cicd-reviewer`
...
| Intenção | Evento |
|----------|--------|
| Iniciar review | `devops-cicd-reviewer_in_code_review` |
| Aprovar | `devops-cicd-reviewer_ready_for_test` |
| Pedir mudanças | `devops-cicd-reviewer_return_in_progress` |
...
- Decisão: **Gateway:** `start_review`, `approve_review` ou `request_changes` via `emit_status_event`
- Decisão: **Handoff:** ler `agents/00-runtime/output/{task_id}/handoff.json`
- README: [`agents/devops-cicd-reviewer/README.md`](README.md)
