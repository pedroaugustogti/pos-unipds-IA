...
**Classificação:** reviewer · **Papel:** `qa-author-reviewer`
...
| Intenção | Evento |
|----------|--------|
| Iniciar review | `qa-author-reviewer_in_code_review` |
| Aprovar | `qa-author-reviewer_ready_for_test` |
| Pedir mudanças | `qa-author-reviewer_return_in_progress` |
...
- Decisão: **Gateway:** `start_review`, `approve_review` ou `request_changes` via `emit_status_event`
- Decisão: **Handoff:** ler `agents/00-runtime/output/{task_id}/handoff.json`
- README: [`agents/qa-author-reviewer/README.md`](README.md)
