...
**qa-author-reviewer** — par de `qa-author` (harness/cenários).
...
Valida cenários E2E críticos e estabilidade do harness.
...
Trigger: **Ready for Code Review** + `agent:qa`. Finaliza: `--creator qa-author --finalize`.