...
**Classificação:** reviewer · **Papel:** `frontend-mobile-reviewer`
...
| Intenção | Evento |
|----------|--------|
| Iniciar review | `frontend-mobile-reviewer_in_code_review` |
| Aprovar | `frontend-mobile-reviewer_ready_for_test` |
| Pedir mudanças | `frontend-mobile-reviewer_return_in_progress` |
...
- README: [`agents/frontend-mobile-reviewer/README.md`](README.md)
