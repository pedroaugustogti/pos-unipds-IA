...
**Classificação:** reviewer · **Papel:** `cloud-infra-reviewer`
...
| Intenção | Evento |
|----------|--------|
| Iniciar review | `cloud-infra-reviewer_in_code_review` |
| Aprovar | `cloud-infra-reviewer_ready_for_test` |
| Pedir mudanças | `cloud-infra-reviewer_return_in_progress` |
...
- README: [`agents/cloud-infra-reviewer/README.md`](README.md)
