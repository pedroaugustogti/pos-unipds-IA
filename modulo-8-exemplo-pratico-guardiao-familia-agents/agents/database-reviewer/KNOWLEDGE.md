...
**Classificação:** reviewer · **Papel:** `database-reviewer`
...
| Intenção | Evento |
|----------|--------|
| Iniciar review | `database-reviewer_in_code_review` |
| Aprovar | `database-reviewer_ready_for_test` |
| Pedir mudanças | `database-reviewer_return_in_progress` |
...
- README: [`agents/database-reviewer/README.md`](README.md)
