...
**Faz:** lista as tools (gateway, phase, orchestrator, qa_mobile, meta) e flag writes.

**Grupos:** gateway (5) · phase (3) · orchestrator (1) · qa_mobile (3) · meta (1).
"""
...
TOOL_CATALOG = [
    ...
    {"name": "qa_init_suite_mobile", "group": "qa_mobile", "writes": True},
    {"name": "qa_pipeline_evidence", "group": "qa_mobile", "writes": False},
    {"name": "qa_generate_evidence", "group": "qa_mobile", "writes": True},
