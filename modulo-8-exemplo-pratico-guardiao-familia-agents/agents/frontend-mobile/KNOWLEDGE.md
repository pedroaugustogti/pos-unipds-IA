...
**Classificação:** creator · **Papel:** `frontend-mobile` · Revisor: `frontend-mobile-reviewer`

| Tool | Quando |
|------|--------|
| `list_status_events` | Filtrar `agent_role=frontend-mobile` |
...
| Status | Evento |
|--------|--------|
| In Progress | `frontend-mobile_in_progress` |
| Ready for Code Review | `frontend-mobile_ready_for_code_review` (+ `pr_url`) |
| In Code Review | `frontend-mobile_in_code_review` |
...
- README: [`agents/frontend-mobile/README.md`](README.md)
