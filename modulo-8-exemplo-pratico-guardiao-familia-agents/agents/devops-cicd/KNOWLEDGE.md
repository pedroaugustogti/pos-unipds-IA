...
**Classificação:** creator · **Papel:** `devops-cicd` · Revisor: `devops-cicd-reviewer`

| Tool | Quando |
|------|--------|
| `list_status_events` | Filtrar `agent_role=devops-cicd` |
...
| Status | Evento |
|--------|--------|
| In Progress | `devops-cicd_in_progress` |
| Ready for Code Review | `devops-cicd_ready_for_code_review` (+ `pr_url`) |
| In Code Review | `devops-cicd_in_code_review` |
...
- README: [`agents/devops-cicd/README.md`](README.md)
