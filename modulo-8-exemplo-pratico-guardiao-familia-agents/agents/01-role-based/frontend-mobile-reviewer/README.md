...
- **Gateway:** eventos role-based `frontend-mobile-reviewer_in_code_review`, `frontend-mobile-reviewer_ready_for_test`, `frontend-mobile-reviewer_return_in_progress` via `emit_status_event`
