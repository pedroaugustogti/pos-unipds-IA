...
Referência completa: [REPOS_AND_ROUTING.md](../../00-orchestration/docs/routing/REPOS_AND_ROUTING.md) · [STATEGRAPH_FLOW.md](../../00-orchestration/docs/graph/STATEGRAPH_FLOW.md). LangGraph reclassifica via `lib/agent_registry.resolve_agent_for_task` antes de `implement`.
