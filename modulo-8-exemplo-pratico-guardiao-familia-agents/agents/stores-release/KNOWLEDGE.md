...
**Classificação:** creator · **Papel:** `stores-release` · Revisor: `stores-release-reviewer`

| Tool | Quando |
|------|--------|
| `list_status_events` | Filtrar `agent_role=stores-release` |
...
| Status | Evento |
|--------|--------|
| In Progress | `stores-release_in_progress` |
| Ready for Code Review | `stores-release_ready_for_code_review` (+ `pr_url`) |
| In Code Review | `stores-release_in_code_review` |
...
- README: [`agents/stores-release/README.md`](README.md)
