...
**Classificação:** reviewer · **Papel:** `frontend-web-reviewer`
...
| Intenção | Evento |
|----------|--------|
| Iniciar review | `frontend-web-reviewer_in_code_review` |
| Aprovar | `frontend-web-reviewer_ready_for_test` |
| Pedir mudanças | `frontend-web-reviewer_return_in_progress` |
...
- Decisão: **Gateway:** `start_review`, `approve_review` ou `request_changes` via `emit_status_event`
- Decisão: **Handoff:** ler `agents/00-runtime/output/{task_id}/handoff.json` antes de revisar
- README: [`agents/frontend-web-reviewer/README.md`](README.md)
