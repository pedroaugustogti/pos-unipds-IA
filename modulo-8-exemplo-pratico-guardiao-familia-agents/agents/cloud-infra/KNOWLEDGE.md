...
**Classificação:** creator · **Papel:** `cloud-infra` · Revisor: `cloud-infra-reviewer`

| Tool | Quando |
|------|--------|
| `list_status_events` | Filtrar `agent_role=cloud-infra` |
...
| Status | Evento |
|--------|--------|
| In Progress | `cloud-infra_in_progress` |
| Ready for Code Review | `cloud-infra_ready_for_code_review` (+ `pr_url`) |
| In Code Review | `cloud-infra_in_code_review` |
...
- README: [`agents/cloud-infra/README.md`](README.md)
