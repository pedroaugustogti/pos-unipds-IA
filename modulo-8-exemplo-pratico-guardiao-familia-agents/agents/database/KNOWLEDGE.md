...
**Classificação:** creator · **Papel:** `database` · Revisor: `database-reviewer`

| Tool | Quando |
|------|--------|
| `list_status_events` | Filtrar `agent_role=database` |
...
| Status | Evento |
|--------|--------|
| In Progress | `database_in_progress` |
| Ready for Code Review | `database_ready_for_code_review` (+ `pr_url`) |
| In Code Review | `database_in_code_review` |
...
- README: [`agents/database/README.md`](README.md)
