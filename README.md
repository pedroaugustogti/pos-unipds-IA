...
| 4 | [`modulo-5-exemplo-4-cypress-openspec`](./modulo-5-exemplo-4-cypress-openspec/) | **Cypress + OpenSpec** — testes E2E spec-driven com Cypress no `cfp-platform` ([modulo-04 UNIPDS](https://github.com/unipds-engenharia-de-ia-aplicada/engenharia-de-software-com-ia-aplicada/tree/main/modulo05-ferramentas-de-IA-para-UI-UX/modulo-04)) |
