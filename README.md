...
| prático | [`modulo-8-exemplo-pratico-guardiao-familia-agents`](./modulo-8-exemplo-pratico-guardiao-familia-agents/) | **Agents Guardião Família** — gateway de eventos, supervisor/workers, qa-author×qa-gate, HITL (merge/blocker/alto risco), handoff e relatório de operação |
