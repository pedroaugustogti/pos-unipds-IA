...
| 2 | [`modulo-7-exemplo-pratico-guardiao-familia`](./modulo-7-exemplo-pratico-guardiao-familia/) | **Guardião Família** — caso real [guardiaofamilia](https://github.com/orgs/guardiaofamilia): planejamento 6M (RICE/WSJF, Monte Carlo), **board v2** com **272 tasks** (24 épicos, 13 sprints), refinamento por task, import GraphQL no [GitHub Project #2](https://github.com/orgs/guardiaofamilia/projects/2), **dashboard HTML** offline e **8 agentes criadores + 8 revisores** com CrewAI e sync de board → PR |
...
Exemplo prático Guardião Família: [`modulo-7-exemplo-pratico-guardiao-familia/README.md`](./modulo-7-exemplo-pratico-guardiao-familia/README.md) · Board e dashboard: [`docs/criacao-board/`](./modulo-7-exemplo-pratico-guardiao-familia/docs/criacao-board/README.md) · Agentes: [`10-agents/`](./modulo-7-exemplo-pratico-guardiao-familia/docs/criacao-board/10-agents/README.md)
