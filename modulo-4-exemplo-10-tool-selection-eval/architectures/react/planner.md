...
regras:
  ...
  - so usar FINALIZAR quando todas as evidencias necessarias foram coletadas E relatorio_incidente ja foi chamado
  - retornar APENAS JSON valido — sem markdown, sem texto antes ou depois do objeto
  - se metricas, logs, deploys e issues ja foram coletados, proxima acao deve ser relatorio_incidente (nao consultar_metricas)
```
